class App {
        ...
        e &&
            e.forEach(function (e) {
                e.addEventListener("click", function (e) {
                    e.preventDefault();
                    var t,
                        e = e.target.closest(".card").querySelector(".card-body");
                    e.style.position = "relative";
                    let a = e.querySelector(".card-overlay");
                    a ||
                        ((a = document.createElement("div")).classList.add("card-overlay"),
                    ...
                    if (s.isIntersecting) {
                        let e = s.target,
                            ...
                            o =
                                ...
                                () => {
                                    a < t
                                        ? ((a += i) > t && (a = t), (e.innerText = n(a)), requestAnimationFrame(o))
                                        : (e.innerText = n(t));
                                });
                        function n(e) {
                            return e % 1 == 0
                                ? e.toLocaleString()
                                : e.toLocaleString(void 0, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                        }
                        o(), r.unobserve(e);
                    }
                });
    ...
    initPassword() {
        document.querySelectorAll("[data-password]").forEach((e) => {
            let t = e.querySelector(".form-password"),
                a = e.querySelector(".password-eye-on"),
                i = e.querySelector(".password-eye-off");
            t &&
                a &&
                i &&
                (i.classList.add("d-none"),
                a.addEventListener("click", () => {
                    (t.type = "text"), a.classList.add("d-none"), i.classList.remove("d-none");
                }),
                i.addEventListener("click", () => {
                    (t.type = "password"), i.classList.add("d-none"), a.classList.remove("d-none");
                }));
        });
    }
    initDismissible() {
    ...
    initSidenav() {
        let n = document.querySelector(".side-nav");
        if (n) {
            n.querySelectorAll("li [data-bs-toggle='collapse']").forEach((e) => {
                e.addEventListener("click", (e) => e.preventDefault());
            });
            let o = n.querySelectorAll("li .collapse"),
                e =
                    (o.forEach((e) => {
                        e.addEventListener("show.bs.collapse", (e) => {
                            let t = e.target,
                                a = [],
                                i = t.parentElement;
                            for (; i && i !== n; ) i.classList.contains("collapse") && a.push(i), (i = i.parentElement);
                            o.forEach((e) => {
            ...
            n.querySelectorAll(".side-nav-link[href]").forEach((t) => {
                var a = t.getAttribute("href");
                if (a && (a === s || t.href === e)) {
                    n.querySelectorAll("a.active, li.active, .collapse.show").forEach((e) => {
                        e.classList.remove("active", "show");
                    }),
                        t.classList.add("active");
                    a = t.closest("li.side-nav-item");
                    ...
                    for (; e && e !== n; ) {
                        ...
                        e = o
                            ? (o.classList.add("show"),
                              (i = n.querySelector(`a[href="#${o.id}"]`)) &&
                                  (i.setAttribute("aria-expanded", "true"), (i = i.closest("li.side-nav-item"))) &&
                ...
                setTimeout(() => {
                    var e = n.querySelector("li.active .active"),
...
class LayoutCustomizer {
    ...
    isFirstVisit() {
        return (
            !localStorage.getItem("__user_has_visited__") && (localStorage.setItem("__user_has_visited__", "true"), !0)
        );
    }
    openCustomizer() {
    ...
    changeSkin(e) {
        (this.config.skin = e), this.html.setAttribute("data-skin", e), this.setSwitchFromConfig();
    }
    changeSidenavColor(e) {
    ...
    setSwitchFromConfig() {
        var e = this.config;
        sessionStorage.setItem("__SIMPLE_CONFIG__", JSON.stringify(e)),
            document.querySelectorAll(".right-bar input[type=checkbox]").forEach((e) => (e.checked = !1));
        ((e, t) => {
            e = document.querySelector(e);
            e && (e.checked = t);
            ...
            [
                ...
                ["data-sidenav-color", e.sidenav.color],
    ...
    initSwitchListener() {
        var e = (e, t) => {
            ...
            e =
                (document
                    ...
                    .forEach((e) => e.addEventListener("click", () => this.changeSkin(e.getAttribute("data-skin")))),
                e('input[name="data-sidenav-color"]', (e) => this.changeSidenavColor(e.value)),
                e('input[name="data-sidenav-size"]', (e) => this.changeSidenavSize(e.value)),
                ...
                e('input[name="sidebar-user"]', (e) => this.changeSidenavUser(e.checked)),
        ...
        e &&
            ...
            document.querySelectorAll(".button-collapse-toggle").forEach((e) => {
                e.addEventListener("click", () => {
                    var e = this.html.getAttribute("data-sidenav-size");
                    "offcanvas" === e
                        ? (this.showBackdrop(), this.html.classList.toggle("sidebar-enable"))
                        : this.changeSidenavSize({ default: "collapse", collapse: "default" }[e], !0);
                });
            });
    }
    showBackdrop() {
        ...
        (a.id = "custom-backdrop"),
            (a.className = "offcanvas-backdrop fade show"),
    ...
    _adjustLayout() {
        ...
        e <= 1199 ? this.changeSidenavSize("offcanvas", !1) : this.changeSidenavSize(t);
    }
    initWindowSize() {
...
class Plugins {
    ...
    initTouchSpin() {
        document.querySelectorAll("[data-touchspin]").forEach((e) => {
            var n = e.querySelector("[data-minus]"),
                r = e.querySelector("[data-plus]");
...
class CustomChartJs {
    ...
    static getDefaultOptions() {
        ...
        return {
            ...
            scales: {
                x: {
                    ticks: { font: { family: e }, color: ins("secondary-color"), display: !0, drawTicks: !0 },
                    grid: { display: !1, drawBorder: !1 },
                    border: { display: !1 },
                },
                y: {
                    ticks: { font: { family: e }, color: ins("secondary-color") },
                    grid: { display: !0, drawBorder: !1, color: ins("chart-border-color"), lineWidth: 1 },
            ...
            plugins: {
                ...
                tooltip: { enabled: !0, titleFont: { family: e }, bodyFont: { family: e } },
            },
        };
    }
    render() {
        try {
            var e, t, a, i;
            (this.element =
                this.selector instanceof HTMLElement ? this.selector : document.querySelector(this.selector)),
                this.element
                    ? (this.chart && this.chart.destroy(),
                      ...
                      (this.chart = new Chart(this.element, {
                          type: e || "bar",
                          data: t,
                          options: { ...structuredClone(CustomChartJs.getDefaultOptions()), ...(a || {}) },
                          plugins: i || [],
                      })),
